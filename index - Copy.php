...
?>
		...
		<div class="samepost clear">
			<h2><a href="post.php?id=7">html post here</a></h2>
			<h4>July 26, 2017, 1:37 am, By <a href="#">Saidur</a></h4>
			 <a href="#"><img src="admin/upload/9b2bba6606.jpg" alt="post image"></a>
			...
			</p><div class="readmore clear">
				<a href="post.php?id=7">Read More</a>
			</div>
		</div>
